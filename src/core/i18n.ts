...
const ES: Record<string, string> = {
  ...
  "{n} gold": "{n} de oro",
  "Measuring with the video: {done} of {total} games": "Midiendo con el vídeo: {done} de {total} partidas",
  "One after another, about 4 min each. You can keep using the app; the figures update as each one finishes.": "Una detrás de otra, unos 4 min cada una. Puedes seguir usando la app; las cifras se actualizan al terminar cada una.",
  "{done} games measured with the video; {failed} couldn't be processed.": "{done} partidas medidas con el vídeo; {failed} no se pudieron procesar.",
  "All your games are measured with the video.": "Todas tus partidas están medidas con el vídeo.",
  "1 game has its pressure estimated, not measured on the video.": "1 partida tiene la presión estimada, sin medir con el vídeo.",
  "{n} games have their pressure estimated, not measured on the video.": "{n} partidas tienen la presión estimada, sin medir con el vídeo.",
  "Measure it": "Medirla",
  "Measure them": "Medirlas",
  "About {min} min in total, one after another. Measured episodes are more accurate: from Riot's data alone, about half of them are right.": "Unos {min} min en total, una detrás de otra. Los episodios medidos son más fiables: solo con los datos de Riot acierta más o menos la mitad.",
