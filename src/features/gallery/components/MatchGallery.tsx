              ...
              >
                ...
                <div style={styles.cardMain}>
                  <div style={styles.cardTop}>
                    <ChampionAvatar champion={match.champion} size={44} ring={accent} />
                    ...
                    <span style={{ ...styles.resultPill, color: accent, borderColor: accent }}>{resultLabel}</span>
                  </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  title: { margin: 0, fontSize: "var(--font-xl)", fontWeight: 800, letterSpacing: "-0.025em" },
  count: {
  ...
  subLine: { fontSize: "var(--font-xs)", color: "var(--text-muted)" },
  resultPill: {
    fontSize: "10px",
    fontWeight: 800,
  ...
  kdaGroup: { display: "flex", alignItems: "center", gap: "5px", fontSize: "var(--font-sm)" },
  ...
  emptyIcon: { fontSize: "52px", marginBottom: "var(--space-4)", opacity: 0.7 },
