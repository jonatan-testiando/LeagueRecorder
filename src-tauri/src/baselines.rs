...
const DECILES: [(&str, [f64; 9]); 5] = [
    ("TOP", [-0.082, -0.041, -0.009, 0.018, 0.047, 0.078, 0.115, 0.165, 0.248]),   // n=25933
    ("JUNGLE", [-0.053, -0.017, 0.011, 0.038, 0.062, 0.091, 0.124, 0.167, 0.243]),   // n=25949
    ("MIDDLE", [-0.067, -0.028, 0.001, 0.029, 0.056, 0.086, 0.121, 0.169, 0.251]),   // n=25940
    ("BOTTOM", [-0.066, -0.029, -0.001, 0.025, 0.051, 0.080, 0.114, 0.159, 0.242]),   // n=25935
...
const DECILES_POR_TRAMO: &[(&str, &str, [f64; 9])] = &[
    ...
    ("alto", "TOP", [-0.082, -0.043, -0.014, 0.013, 0.040, 0.070, 0.104, 0.145, 0.217]),   // n=8283
    ("alto", "JUNGLE", [-0.042, -0.007, 0.023, 0.050, 0.078, 0.107, 0.137, 0.180, 0.246]),   // n=8285
    ("alto", "MIDDLE", [-0.067, -0.030, -0.002, 0.025, 0.050, 0.080, 0.113, 0.157, 0.232]),   // n=8284
    ("alto", "BOTTOM", [-0.064, -0.027, 0.002, 0.028, 0.054, 0.082, 0.116, 0.159, 0.236]),   // n=8284
    ("alto", "UTILITY", [-0.097, -0.067, -0.046, -0.029, -0.013, 0.004, 0.023, 0.044, 0.074]),   // n=8284
];
